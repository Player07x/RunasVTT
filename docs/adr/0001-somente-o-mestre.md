...
- **Status:** aceita (2026-09-18) · revisada pelo ADR 0009 (servidor de transmissão para a Vista dos Jogadores), pelo ADR 0017 (espectadores podem mover tokens "Jogador", com validação no VTT; o resto da mesa continua só com o mestre) e pelo ADR 0019 (assentos com código: passa a existir identidade de jogador, efêmera, e escrita de ficha pela rede)
